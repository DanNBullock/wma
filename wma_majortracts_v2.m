...
% Modified by Daniel Bullock Indiana University 2017 9/25/2017
...
for iRemove=1:length(removeTracts)
    targetInd=strfind(labels,removeTracts{iRemove});
    ...
    for iRemoveHere=1:length(removeThese)
        ...
        fprintf('\n removing Old %s from classification', labels{removeIND})
        labels(removeIND)=[];
